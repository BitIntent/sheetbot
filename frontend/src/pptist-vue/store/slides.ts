...
export const useSlidesStore = defineStore('slides', {
  state: (): SlidesState => ({
    ...
    templates: [
      ...
      { name: '霓虹夜幕', id: 'template_9', cover: '/images/template_9.svg', origin: '本地新增（Pexels 风格素材）' },
      { name: '暖阳纸纹', id: 'template_10', cover: '/images/template_10.svg', origin: '本地新增（Pexels 风格素材）' },
    ], // 模板
  }),
